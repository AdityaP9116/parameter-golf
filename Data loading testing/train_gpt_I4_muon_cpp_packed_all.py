...
class DistributedTokenLoader:
    ...
    def _prefetch_worker(self, global_tokens: int, seq_len: int, grad_accum_steps: int):
        ...
        # Allocate pinned memory boundaries outside loop natively
        ...
        while True:
            ...
            # 4. Late Casting bounds across DMA mapping lines explicitly downcast
